...
const Footer = ({footer}) => {
  return (
    ...
    <div className="preFooter">
        ...
        <div>
            {repeatIcon}
            <p><b>Hassle-free replacement</b><br />10 day easy replacement pilicy on mi.com</p>
        </div>
        <div>
            {shieldIcon}
    ...
    <div className="footer">
        <div>
            ...
            {footer.support.map((item,index)=>(
                <a key={item.url} href={item.url} alt={`${index} url`}>{item.name}</a>
            ))}
        </div>
        <div>
            <p>SHOP & LEARN</p>
        ...
        <div>
            <div>Chat with our Virtual AI Bot <br />(24/7 Live Agent Support)</div>
            <button>CHAT NOW</button>
        </div>
    </div>

    <div className="footerBorder">
        <div>Copyright &copy; 2010 - 2011 Xiomi. All Rights Reserved</div>
    </div>
